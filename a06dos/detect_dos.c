...
#define DUNIT           0x0301
#define SPARTADOS_MAGIC 0x0700
#define SPARTA_VERSION  0x0701
#define BEWEDOS_MAGIC   0x0703
#define SPARTA_FILE_ID  0x0760
#define SPARTA_DEVICE   0x0761
...
{
	printf("\n");
	c = PEEK(SPARTADOS_MAGIC);
	if (c == 'S')
		sparta();
	else if (c == '\x0B' || c == '\xE8')
		printf("Very old SpartaDOS 0x0700=%#x\n", c);
	else
		printf("No SpartaDOS 0x0700=%c\n", c);
